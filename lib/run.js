    ...
    if (er){ throw er}
      ...
      if (secret && secret.length && secret.length > 1){
        ...
        try{
          ...
          console.warn("WARNING: Session Secret not passed in via CLI, env var, or .sessionsecret file. \r\n"+
            "Session secret will be randomized and your sessions won't be valid between restarts.")
